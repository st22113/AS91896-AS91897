...
# Grid 
label_name.grid(row=2, column=0, pady=5, padx=20, sticky="e")
label_receipt.grid(row=3, column=0, pady=5, padx=20, sticky="e")
label_item.grid(row=4, column=0, pady=5, padx=20, sticky="e")
label_quantity.grid(row=5, column=0, pady=5, padx=20, sticky="e")
